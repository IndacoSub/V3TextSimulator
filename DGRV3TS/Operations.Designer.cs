namespace DGRV3TS
{
	partial class Operations
	{
		...
		private void InitializeComponent()
		{
			...
			DumpSelectedVoicelinesButton = new Button();
			toolTip1 = new ToolTip(components);
			OpenVerticalViewButton = new Button();
			...
			// 
			NumericUpDownFontSize.Location = new Point(1437, 137);
			...
			// 
			DumpSelectedVoicelinesButton.Location = new Point(1503, 117);
			DumpSelectedVoicelinesButton.Name = "DumpSelectedVoicelinesButton";
			DumpSelectedVoicelinesButton.Size = new Size(40, 29);
			DumpSelectedVoicelinesButton.TabIndex = 1;
			DumpSelectedVoicelinesButton.Text = "[S<]";
			DumpSelectedVoicelinesButton.UseVisualStyleBackColor = true;
			DumpSelectedVoicelinesButton.Click += DumpVoicelineOnlyButton_Click;
			// 
			// OpenVerticalViewButton
			// 
			OpenVerticalViewButton.Location = new Point(1503, 149);
			OpenVerticalViewButton.Name = "OpenVerticalViewButton";
			OpenVerticalViewButton.Size = new Size(40, 25);
			OpenVerticalViewButton.TabIndex = 101;
			OpenVerticalViewButton.Text = "VW";
			OpenVerticalViewButton.UseVisualStyleBackColor = true;
			OpenVerticalViewButton.Click += OpenVerticalViewButton_Click;
			// 
			// Operations
			// 
			AutoScaleMode = AutoScaleMode.None;
			ClientSize = new Size(1546, 179);
			Controls.Add(OpenVerticalViewButton);
			Controls.Add(DumpSelectedVoicelinesButton);
